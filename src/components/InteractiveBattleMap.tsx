...
export const BATTLES_DATA: BattlePoint[] = [
  ...
  },
  {
    ...
    imageUrl: '/images/ww1_gorlice_breakthrough.jpg',
    imageCaption: 'Масований артилерійський обстріл позицій та прорив оборони під час Горлицької операції в Галичині, травень 1915 року.'
  },
  {
    id: 'verdun-1916',
  ...
  },
  {
    ...
    imageUrl: '/images/ww1_lysonia_battle.jpg',
    imageCaption: 'Українські Січові Стрільці тримають оборону на обстріляній вершині гори Лисоня біля Бережан, літо-осінь 1916 року.'
  },
  {
    id: 'somme-1916',
